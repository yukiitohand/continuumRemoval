function [] = cntrmvl_toolbox_startup_addpath(error_if_not_unique,silent_if_not_unique)
% cntrmvl_toolbox_startup_addpath
%  Add paths of continuumRemoval toolbox, while solving dependent toolboxes.
%  Dependent toolboxes: 
%     base
% 
%  USAGE
%  >> cntrmvl_toolbox_startup_addpath()
%  >> cntrmvl_toolbox_startup_addpath(error_if_not_unique)
%  >> cntrmvl_toolbox_startup_addpath(error_if_not_unique,silent_if_not_unique)
%  
...
%% continuumRemoval
cntrmvl_toolbox_dir = fullfile(toolbox_root_dir, cntrmvl_toolbox_dirname);
if ~check_path_exist(cntrmvl_toolbox_dir, pathCell)
    addpath( ...
        cntrmvl_toolbox_dir                                  , ...
        fullfile(cntrmvl_toolbox_dir,'findBandPos/')           ...
    );
end
